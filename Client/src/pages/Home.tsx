          ...
          <main className="w-full flex flex-col">
            <section id="about" className="px-6 py-12 lg:py-16">
              ...
              <p className="text-gray-700 leading-relaxed">
                <span className="italic font-semibold text-black">NOIR</span>,
                your premier destination for authentic Brazilian streetwear.
                Born from the vibrant energy and diverse culture of Brazil,
                we're more than just a clothing brand – we're a movement. Our
                mission is to capture the essence of Brazilian street style and
                share it with the world.
              </p>
            </section>
            <section
              id="best-sellers"
              className="px-6 py-12 lg:py-16 bg-gray-50"
            >
              <h2 className="font-bold text-3xl lg:text-4xl text-center">
                Best-Sellers
              </h2>
              <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="relative w-full aspect-square rounded-lg shadow-md bg-[#0F0F0F] overflow-hidden group">
                  <img
                    src={roupa1}
                    alt="Primeira roupa"
