...
export default function Aside({ onClose }: AsideProps) {
  ...
  return (
    ...
    <aside className="h-full w-full bg-[#0F0F0F] text-white lg:relative">
      ...
      <div className="p-4 lg:p-0">
        <div className="flex flex-col">
          <button
            ...
            className="font-bold text-left px-4 lg:pl-6 pr-2 py-4 border-b border-gray-800 transition hover:bg-gray-900 flex justify-between items-center"
          >
            Collections<span>{isFirstListOpen ? "▲" : "▼"}</span>
          </button>
          <div
            className={`overflow-hidden transition-all duration-300 ease-in-out ${
              isFirstListOpen ? "max-h-[500px]" : "max-h-0"
            }`}
          >
            <ul className="flex flex-col bg-gray-950">
              <li className="w-full pl-6 py-3 border-b border-gray-800 hover:bg-gray-800">
        ...
        <div className="flex flex-col">
          ...
          <div
            className={`overflow-hidden transition-all duration-300 ease-in-out ${
              isSecondListOpen ? "max-h-[500px]" : "max-h-0"
            }`}
          >
            <ul className="flex flex-col bg-gray-950">
              <li className="w-full pl-6 py-3 border-b border-gray-800 hover:bg-gray-800">
